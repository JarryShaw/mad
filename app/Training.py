...
def main(unused):
    ...
    # Used for system operating
        ...
        print('names:', names)
        if names:
            predict_input_fn = tf.estimator.inputs.numpy_input_fn(x={"packet": packets},
                                                                  num_epochs=1,
                                                                  shuffle=False)
        ...
        # fetch malicious data detected by fingerprint
        Malicious = []
        group_dict = {T: []}
        ...
        # fetch clean data detected by fingerprint
        Clean = []
