...
from fingerprints.detection import DetectionModule  # pylint: disable=E0401, E0602
from fingerprints.fingerprint import FingerprintGenerator  # pylint: disable=E0401, E0602
